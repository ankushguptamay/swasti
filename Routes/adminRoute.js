...
} = require("../Controller/User/Instructor/instructorController");
const {
...
const {
  ...
  addRecordedVideo,
  addContentFile,
} = require("../Controller/Course/createCourseAndContent");
const {
  changeContentStatus,
  changeCourseFileStatus,
  changeCourseStatus,
  changeVideoStatus,
  changeVideoPublish,
  changeContentPublish,
  changeCoursePublish,
  changeContentUpdationStatus,
  changeCourseUpdationStatus,
  changeCourseFilePublish,
} = require("../Controller/Course/approvalCourseAndContent");
const {
  restoreContent,
  restoreCourse,
  restoreFile,
  restoreVideo,
} = require("../Controller/Course/restoreCourseAndContent");
const {
  getAllCourse,
  getCourseByIdForAdmin,
  getSoftDeletdContentByContentId,
  getFileByContentId,
  getVideoByContentId,
  getAllContentUpdationRequest,
  getAllCourseUpdationRequest,
  getAllSoftDeletedCourse,
  getAllSoftDeletedContentByCourseId,
} = require("../Controller/Course/getCourseAndContent");
const {
  studentToCourse,
  updateContentForAdmin,
  updateCourseForAdmin,
} = require("../Controller/Course/updateCourseAndContent");
const {
...
const {
  ...
  softDeleteVideo,
  hardDeleteFile,
} = require("../Controller/Course/deleteCourseAndContent");
const {
...
const {
  ...
  getYSBusinessUpdationHistoryById,
  getYSContactUpdationHistoryById,
  getYSTimeUpdationHistoryById,
...
const {
  ...
  changeYogaStudioTimeStatus,
  changeYSBusinessUpdationStatus,
  changeYSContactUpdationStatus,
  changeYSTimingUpdationStatus,
} = require("../Controller/YogaStudio/approveBusinessController");
const {
  softDeleteYogaStudioBusiness,
  softDeleteYogaStudioContact,
  softDeleteYogaStudioImage,
  softDeleteYogaStudioTime,
  hardDeleteYogaStudioBusiness,
  hardDeleteYogaStudioContact,
  hardDeleteYogaStudioImage,
  hardDeleteYogaStudioTime,
} = require("../Controller/YogaStudio/deleteBusinessController");
const {
  restoreYogaStudioBusiness,
  restoreYogaStudioContact,
  restoreYogaStudioImage,
  restoreYogaStudioTime,
} = require("../Controller/YogaStudio/restoreBusinessController");
const {
...
const {
  createTherapySpecilization,
  getAllTherapySpecilization,
  deleteTherapySpecilization,
} = require("../Controller/Master/therapySecilizationController");
const {
  addTherapyType,
  getAllTherapyType,
  deleteTherapyType,
} = require("../Controller/Master/therapyTypeController");
const {
  addHTSpecilization,
...
admin.put(
  "/changeQualificationStatus/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeQualificationStatus
);
admin.delete(
  "/softDeleteQualification/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteQualificationAdmin
);
admin.put(
  "/restoreQualification/:id",
  verifyAdminJWT,
  isAdminPresent,
  restoreQualificationAdmin
);
...
admin.put(
  "/restoreExperienceAdmin/:id",
  verifyAdminJWT,
  isAdminPresent,
  restoreExperienceAdmin
);
admin.delete(
  "/softDeleteExperienceAdmin/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteExperienceAdmin
);
...
admin.post(
  ...
  verifyAdminJWT,
  isAdminPresent,
  uploadImage.single("CourseImage"),
  addCourseImage
); // courseId
admin.post(
  "/addTeacherImage/:id",
...
admin.post(
  ...
  verifyAdminJWT,
  isAdminPresent,
  uploadImageAndPDF.single("ContentFile"),
  addContentFile
); // contentId
admin.post(
  "/addRecordedVideo/:id",
...
admin.get(
  "/softDeletedContent/:id",
  verifyAdminJWT,
  isAdminPresent,
  getAllSoftDeletedContentByCourseId
); // Soft Deleted Content courseId
admin.get(
  "/getSoftDeletdContent/:id",
  verifyAdminJWT,
  isAdminPresent,
  getSoftDeletdContentByContentId
); // contentId
...
admin.get(
  "/courseUpdationRequests",
  verifyAdminJWT,
  isAdminPresent,
  getAllCourseUpdationRequest
);
admin.get(
  "/contentUpdationRequests",
  verifyAdminJWT,
  isAdminPresent,
  getAllContentUpdationRequest
);
...
admin.put(
  "/changeCourseUpdationStatus/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeCourseUpdationStatus
);
admin.put(
  "/changeContentUpdationStatus/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeContentUpdationStatus
);
...
admin.get(
  ...
  isAdminPresent,
  totalDraftedCourse
); // course created by instructor but not submit for approval
admin.get(
  "/totalPendingCourse",
  verifyAdminJWT,
  isAdminPresent,
  totalPendingCourse
); // submited by instructor for approval
admin.get(
  "/totalPublishedCourse",
  verifyAdminJWT,
  isAdminPresent,
  totalPublishedCourse
); // user can see this courses
admin.get(
  "/totalVerifiedCourse",
  verifyAdminJWT,
  isAdminPresent,
  totalVerifiedCourse
); // approved by swasti, user can see if courses is published
...
admin.get(
  "/getYSBusinessUpdation/:id",
  verifyAdminJWT,
  isAdminPresent,
  getYSBusinessUpdationHistoryById
);
admin.get(
  "/getYSContactUpdation/:id",
  verifyAdminJWT,
  isAdminPresent,
  getYSContactUpdationHistoryById
);
admin.get(
  "/getYSTimeUpdation/:id",
  verifyAdminJWT,
  isAdminPresent,
  getYSTimeUpdationHistoryById
);
...
admin.put(
  "/changeYogaStudioBusiness/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeYogaStudioBusinessStatus
);
admin.put(
  "/changeYogaStudioContact/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeYogaStudioContactStatus
);
admin.put(
  "/changeYogaStudioImage/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeYogaStudioImageStatus
);
admin.put(
  "/changeYogaStudioTime/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeYogaStudioTimeStatus
);
...
admin.put(
  "/changeYSBusinessUpdationStatus/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeYSBusinessUpdationStatus
);
admin.put(
  "/changeYSContactUpdationStatus/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeYSContactUpdationStatus
);
admin.put(
  "/changeYSTimingUpdationStatus/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeYSTimingUpdationStatus
);
...
admin.delete(
  "/softDeleteYSBusiness/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteYogaStudioBusiness
);
admin.delete(
  "/softDeleteYSContact/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteYogaStudioContact
);
admin.delete(
  "/softDeleteYSImage/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteYogaStudioImage
);
...
admin.delete(
  "/hardDeleteYSBusiness/:id",
  verifyAdminJWT,
  isAdminPresent,
  hardDeleteYogaStudioBusiness
);
admin.delete(
  "/hardDeleteYSContact/:id",
  verifyAdminJWT,
  isAdminPresent,
  hardDeleteYogaStudioContact
);
admin.delete(
  "/hardDeleteYSImage/:id",
  verifyAdminJWT,
  isAdminPresent,
  hardDeleteYogaStudioImage
);
...
admin.get(
  "/getDeletedHTImages/:id",
  verifyAdminJWT,
  isAdminPresent,
  getDeletedHTImages
); //id = homeTutorId
admin.get(
  "/getDeletedHTServiceArea/:id",
  verifyAdminJWT,
  isAdminPresent,
  getDeletedHTServiceArea
); //id = homeTutorId
admin.get(
  "/getDeletedHTTimeSlotes/:id",
  verifyAdminJWT,
  isAdminPresent,
  getDeletedHTTimeSlotes
); //id = homeTutorId
...
admin.put(
  "/changeHomeTutorStatus/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeHomeTutorStatus
);
admin.put(
  "/changeHTutorUpdationStatus/:id",
  verifyAdminJWT,
  isAdminPresent,
  changeHTutorUpdationStatus
);
...
admin.delete(
  "/softDeleteHTutorImage/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteHTutorImage
);
admin.delete(
  "/softDeleteHTutorServiceArea/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteHTutorServiceArea
);
admin.delete(
  "/softDeleteHTutorTimeSlote/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteHTutorTimeSlote
);
admin.delete(
  "/softDeleteHomeTutor/:id",
  verifyAdminJWT,
  isAdminPresent,
  softDeleteHomeTutor
);
...
admin.put(
  "/restoreHTutorImage/:id",
  verifyAdminJWT,
  isAdminPresent,
  restoreHTutorImage
);
admin.put(
  "/restoreHTutorServiceArea/:id",
  verifyAdminJWT,
  isAdminPresent,
  restoreHTutorServiceArea
);
admin.put(
  "/restoreHTutorTimeSlote/:id",
  verifyAdminJWT,
  isAdminPresent,
  restoreHTutorTimeSlote
);
