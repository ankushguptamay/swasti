...
const {
  ...
  getContentAndFile,
  totalStudent,
} = require("../Controller/User/Instructor/dashboardController");
const {
  createCoupon,
  softDeleteCoupon,
...
const {
  createNotificationForInstructor,
  getMyNotificationForInstructor,
  getNotificationForInstructor,
} = require("../Controller/createNotificationCont");
const {
  getPaymentDetailsForInstructor,
...
} = require("../Controller/YogaStudio/createBusinessController");
const {
  getMyYogaStudioForInstructor,
  getYogaStudioById,
...
const {
  submitYSContactForApproval,
  submitYSImageForApproval,
  submitYSTimeForApproval,
  submitYogaStudioForApproval,
  publishYogaStudio,
} = require("../Controller/YogaStudio/approveBusinessController");
const {
  updateYogaStudioBusiness,
  updateYogaStudioContact,
  updateYogaStudioTime,
...
const {
  createTherapy,
  addTherapyImage,
  addTherapySeviceArea,
  addTherapyTimeSlote,
  addTherapyTypeOffered,
} = require("../Controller/Therapy/createTherapyController");
const {
  getMyTherapyForInstructor,
  getTherapyById,
...
const {
  ...
  isInstructorForTherapist,
  isInstructorForYogaStudio,
...
instructor.put("/updateKYC/:id", verifyInstructorJWT, updateKYC);
instructor.delete(
...
instructor.put(
  "/updateExperiencen/:id",
  verifyInstructorJWT,
  isInstructorProfileComplete,
  updateExperiencen
);
instructor.delete(
  "/deleteExperienceInstructor/:id",
  verifyInstructorJWT,
  isInstructorProfileComplete,
  deleteExperienceInstructor
);
...
instructor.put(
  "/submitContentForApproval/:id",
  verifyInstructorJWT,
  isInstructorForCourse,
  submitContentForApproval
); // contentId
instructor.put(
  "/submitCourseForApproval/:id",
  verifyInstructorJWT,
  isInstructorForCourse,
  submitCourseForApproval
); // courseId
instructor.put(
  "/submitFileForApproval/:id",
  verifyInstructorJWT,
  isInstructorForCourse,
  submitFileForApproval
); // fileId
instructor.put(
  "/submitVideoForApproval/:id",
  verifyInstructorJWT,
  isInstructorForCourse,
  submitVideoForApproval
); // videoId
...
instructor.post(
  "/createYogaStudioContact/:id",
  verifyInstructorJWT,
  isInstructorForYogaStudio,
  createYogaStudioContact
);
instructor.post(
  "/createYogaStudioImage/:id",
  verifyInstructorJWT,
  isInstructorForYogaStudio,
  uploadImage.array("studioImages", 10),
  createYogaStudioImage
);
instructor.post(
  "/createYogaStudioTiming/:id",
  verifyInstructorJWT,
  isInstructorForYogaStudio,
  createYogaStudioTiming
);
...
instructor.put(
  "/updateYogaStudioBusiness/:id",
  verifyInstructorJWT,
  isInstructorForYogaStudio,
  updateYogaStudioBusiness
);
instructor.put(
  "/updateYogaStudioContact/:id",
  verifyInstructorJWT,
  isInstructorForYogaStudio,
  updateYogaStudioContact
);
instructor.put(
  "/updateYogaStudioTime/:id",
  verifyInstructorJWT,
  isInstructorForYogaStudio,
  updateYogaStudioTime
);
...
instructor.post(
  "/addHTutorSeviceArea/:id",
  verifyInstructorJWT,
  isInstructorForHomeTutor,
  addHTutorSeviceArea
);
instructor.post(
  "/addHTutorTimeSlote/:id",
  verifyInstructorJWT,
  isInstructorForHomeTutor,
  addHTutorTimeSlote
);
...
instructor.delete(
  "/deleteHTutorImage/:id",
  verifyInstructorJWT,
  isInstructorForHomeTutor,
  softDeleteHTutorImage
);
instructor.delete(
  "/deleteHTutorServiceArea/:id",
  verifyInstructorJWT,
  isInstructorForHomeTutor,
  softDeleteHTutorServiceArea
);
instructor.delete(
  "/deleteHTutorTimeSlote/:id",
  verifyInstructorJWT,
  isInstructorForHomeTutor,
  softDeleteHTutorTimeSlote
);
...
instructor.post(
  "/addTherapySeviceArea/:id",
  verifyInstructorJWT,
  isInstructorForTherapist,
  addTherapySeviceArea
);
instructor.post(
  "/addTherapyTimeSlote/:id",
  verifyInstructorJWT,
  isInstructorForTherapist,
  addTherapyTimeSlote
);
instructor.post(
  ...
  verifyInstructorJWT,
  isInstructorForTherapist,
  uploadImage.array("therapyImages", 3),
  addTherapyImage
);
instructor.post(
  "/addTherapyTypeOffered/:id",
  verifyInstructorJWT,
  isInstructorForTherapist,
  addTherapyTypeOffered
);
