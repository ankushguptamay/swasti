...
const { register, login, getStudent, verifyOTP, verifyOTPByLandingPage, registerByLandingPage, registerByNumber, loginByNumber, verifyNumberOTP, getMyChakra, getReferralData } = require('../Controller/User/Student/studentController');
