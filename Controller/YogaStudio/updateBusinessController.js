...
exports.updateYogaStudioBusiness = async (req, res) => {
  try {
    ...
    if (
      yogaStudio.approvalStatusByAdmin === "Pending" ||
      yogaStudio.approvalStatusByAdmin === null
    ) {
...
exports.updateYogaStudioContact = async (req, res) => {
  try {
    ...
    if (
      contact.approvalStatusByAdmin === "Pending" ||
      contact.approvalStatusByAdmin === null
    ) {
...
exports.updateYogaStudioTime = async (req, res) => {
  try {
    ...
    // Body
    const { openAt, closeAt, isSun, isMon, isTue, isWed, isThu, isFri, isSat } =
      req.body;
    ...
    if (
      time.approvalStatusByAdmin === "Pending" ||
      time.approvalStatusByAdmin === null
    ) {
      await time.update({
        ...time,
        openAt: openAt,
