...
const {
  therapyValidation,
  therapyLocationValidation,
  therapyTimeSloteValidation,
  therapyTypeOfferedValidation,
} = require("../../Middleware/Validate/validateTherapy");
...
const fs = require("fs");
const bunnyFolderName = "ther-doc";
...
exports.addTherapyImage = async (req, res) => {
  try {
    ...
    const images = await TherayImages.count({
      where: { therapyId: therapyId, deletedThrough: null },
    });
